...
find_package(Qt4 4.8 ${_bbSystemReq} ${BBSystem_FIND_COMPONENTS})
...
find_path(BB10_INCLUDE_DIR Global.hpp
  HINTS
  ENV BBSYSTEMDIR
  PATH_SUFFIXES include include/bb include/bb/system
  PATHS
...
find_path(BB10_LIBRARY_PATH libbbsystem.so
  HINTS
  ENV BBSYSTEMDIR
  PATH_SUFFIXES lib64 lib libs64 libs libs/Win32 libs/Win64
  PATHS
...
mark_as_advanced(BBSYSTEM_LIBRARY BBSYSTEM_INCLUDE_DIR BB10_INCLUDE_DIR BB10_LIBRARY_PATH)
