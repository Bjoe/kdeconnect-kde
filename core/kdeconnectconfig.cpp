...
/* TODO KLocalizedString       Daemon::instance()->reportError(
    ...
    if (privKey.exists() && privKey.open(QIODevice::ReadOnly)) {
        ...
        if (!privKey.open(QIODevice::ReadWrite | QIODevice::Truncate))  {
            // TODO KLocalizedString Daemon::instance()->reportError(QLatin1String("KDE Connect"), i18n("Could not store private key file: %1", keyPath));
        } else {
